...
⁍ News (Mar 2022): Lim's new paper, [Stochastic Integral representation of solutions to the Hodge theoretic Poisson's equations on Graphs, and value allocation theory of Shapley and Nash](https://tlim0213.github.io/folder/papers/PoissonHodgegraph.pdf), has now appeared, combining Lim's preceding articles [A Hodge theoretic extension of Shapley axioms](https://tlim0213.github.io/folder/papers/ShapleyAxioms.pdf), and  [Hodge theoretic reward allocation for generalized cooperative games on graphs](https://tlim0213.github.io/folder/papers/ShapleyGeneralGraph.pdf).
